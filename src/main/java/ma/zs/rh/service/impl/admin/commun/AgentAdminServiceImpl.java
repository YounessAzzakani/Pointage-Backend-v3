package ma.zs.rh.service.impl.admin.commun;
...
import ma.zs.rh.service.facade.admin.commun.PosteAdminService ;
...
public class AgentAdminServiceImpl implements AgentAdminService {
    ...
    @Autowired
    private PlageHoraireAdminService plageHoraireService ;
    @Autowired
