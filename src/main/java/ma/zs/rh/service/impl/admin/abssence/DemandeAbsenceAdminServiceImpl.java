...
import ma.zs.rh.service.facade.admin.abssence.DemandeAbsenceAdminService;
...
import ma.zs.rh.service.facade.admin.abssence.MotifRejetDemandeAbsenceAdminService ;

@Service
public class DemandeAbsenceAdminServiceImpl implements DemandeAbsenceAdminService {
    ...
    @Autowired
    private RaisonAbsenceAdminService raisonAbsenceService ;
    @Autowired
    private EtatDemandeAbsenceAdminService etatDemandeAbsenceService ;
    @Autowired
    private EntiteAdministrativeAdminService entiteAdministrativeService ;
    @Autowired
    private MotifRejetDemandeAbsenceAdminService motifRejetDemandeAbsenceService ;
