...
import ma.zs.rh.service.facade.agent.retard.EtatRetardAgentService ;
...
public class RetardAgentServiceImpl implements RetardAgentService {
    ...
    @Autowired
    private EtatRetardAgentService etatRetardService ;
    @Autowired
    private JustificationRetardAgentService justificationRetardService ;
