...
public class HeureSupplementaireAdminServiceImpl implements HeureSupplementaireAdminService {
    ...
    @Autowired
    private EtatTypeHeureSupplementaireAdminService etatTypeHeureSupplementaireService ;
    @Autowired
    private TypeHeureSupplementaireAdminService typeHeureSupplementaireService ;
