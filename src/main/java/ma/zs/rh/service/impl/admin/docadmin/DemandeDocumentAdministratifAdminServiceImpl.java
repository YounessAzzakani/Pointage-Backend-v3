...
@Service
public class DemandeDocumentAdministratifAdminServiceImpl implements DemandeDocumentAdministratifAdminService {
    ...
    @Autowired
    private EtatDemandeDocumentAdministratifAdminService etatDemandeDocumentAdministratifService ;
    @Autowired
    private EntiteAdministrativeAdminService entiteAdministrativeService ;
    @Autowired
    private TypeDocumentAdministratifAdminService typeDocumentAdministratifService ;
