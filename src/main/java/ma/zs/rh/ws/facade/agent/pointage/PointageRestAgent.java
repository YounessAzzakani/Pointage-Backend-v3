...
import ma.zs.rh.service.facade.agent.pointage.PointageAgentService;
import ma.zs.rh.ws.converter.pointage.PointageConverter;
...
@RestController
@RequestMapping("/api/agent/pointage/")
public class PointageRestAgent {
    ...
    @Autowired private PointageAgentService service;
