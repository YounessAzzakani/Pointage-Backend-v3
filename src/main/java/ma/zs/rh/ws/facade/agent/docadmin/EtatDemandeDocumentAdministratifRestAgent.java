...
@RestController
@RequestMapping("/api/agent/etatDemandeDocumentAdministratif/")
public class EtatDemandeDocumentAdministratifRestAgent {
    ...
    @Autowired private EtatDemandeDocumentAdministratifAgentService service;
