...
import ma.zs.rh.service.facade.admin.commun.PlageHoraireAdminService;
import ma.zs.rh.ws.converter.commun.PlageHoraireConverter;
...
@RestController
@RequestMapping("/api/admin/plageHoraire/")
public class PlageHoraireRestAdmin {
    ...
    @Autowired private PlageHoraireAdminService service;
