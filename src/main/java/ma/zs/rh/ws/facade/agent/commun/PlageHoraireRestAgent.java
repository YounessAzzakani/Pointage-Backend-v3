package  ma.zs.rh.ws.facade.agent.commun;
...
@RestController
@RequestMapping("/api/agent/plageHoraire/")
public class PlageHoraireRestAgent {
    ...
    @Autowired private PlageHoraireAgentService service;
