...
@RestController
@RequestMapping("/api/admin/motifRejetDemandeAbsence/")
public class MotifRejetDemandeAbsenceRestAdmin {
    ...
    @Autowired private MotifRejetDemandeAbsenceAdminService service;
