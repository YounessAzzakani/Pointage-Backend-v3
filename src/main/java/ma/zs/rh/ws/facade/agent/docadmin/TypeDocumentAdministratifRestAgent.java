...
@RestController
@RequestMapping("/api/agent/typeDocumentAdministratif/")
public class TypeDocumentAdministratifRestAgent {
    ...
    @Autowired private TypeDocumentAdministratifAgentService service;
