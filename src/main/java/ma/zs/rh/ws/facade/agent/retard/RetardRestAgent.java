...
import ma.zs.rh.service.facade.agent.retard.RetardAgentService;
import ma.zs.rh.ws.converter.retard.RetardConverter;
...
@RestController
@RequestMapping("/api/agent/retard/")
public class RetardRestAgent {
    ...
    @Operation(summary = "find by etatRetard id")
    @GetMapping("etatRetard/id/{id}")
    public List<RetardDto> findByEtatRetardId(@PathVariable Long id){
        return findDtos(service.findByEtatRetardId(id));
    }
    @Operation(summary = "delete by etatRetard id")
    @DeleteMapping("etatRetard/id/{id}")
    public int deleteByEtatRetardId(@PathVariable Long id){
        return service.deleteByEtatRetardId(id);
    }
    @Operation(summary = "find by justificationRetard id")
    @GetMapping("justificationRetard/id/{id}")
    public List<RetardDto> findByJustificationRetardId(@PathVariable Long id){
        return findDtos(service.findByJustificationRetardId(id));
    }
    @Operation(summary = "delete by justificationRetard id")
    @DeleteMapping("justificationRetard/id/{id}")
    public int deleteByJustificationRetardId(@PathVariable Long id){
        return service.deleteByJustificationRetardId(id);
    }
    ...
    @Autowired private RetardAgentService service;
