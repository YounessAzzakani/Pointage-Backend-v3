...
@RestController
@RequestMapping("/api/agent/typeHeureSupplementaire/")
public class TypeHeureSupplementaireRestAgent {
    ...
    @Autowired private TypeHeureSupplementaireAgentService service;
