...
@RestController
@RequestMapping("/api/agent/motifRejetDemandeConge/")
public class MotifRejetDemandeCongeRestAgent {
    ...
    @Autowired private MotifRejetDemandeCongeAgentService service;
