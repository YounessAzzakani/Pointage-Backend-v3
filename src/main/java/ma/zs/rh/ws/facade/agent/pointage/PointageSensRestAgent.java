...
import ma.zs.rh.service.facade.agent.pointage.PointageSensAgentService;
...
@RestController
@RequestMapping("/api/agent/pointageSens/")
public class PointageSensRestAgent {
    ...
    @Autowired private PointageSensAgentService service;
