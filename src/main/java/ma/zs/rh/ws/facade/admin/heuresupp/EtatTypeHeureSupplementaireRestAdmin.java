...
@RestController
@RequestMapping("/api/admin/etatTypeHeureSupplementaire/")
public class EtatTypeHeureSupplementaireRestAdmin {
    ...
    @Autowired private EtatTypeHeureSupplementaireAdminService service;
