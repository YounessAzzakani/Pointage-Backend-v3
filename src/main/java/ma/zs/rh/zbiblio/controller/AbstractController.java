package ma.zs.rh.zbiblio.controller;

import jakarta.servlet.http.HttpServletRequest;
import ma.zs.rh.zbiblio.bean.BaseEntity;
import ma.zs.rh.zbiblio.converter.AbstractConverter;
import ma.zs.rh.zbiblio.criteria.BaseCriteria;
import ma.zs.rh.zbiblio.dto.BaseDto;
import ma.zs.rh.zbiblio.dto.FileTempDto;
import ma.zs.rh.zbiblio.exception.BusinessRuleException;
import ma.zs.rh.zbiblio.exception.GlobalException;
import ma.zs.rh.zbiblio.export.ExportModel;
import ma.zs.rh.zbiblio.service.IService;
import ma.zs.rh.zbiblio.util.*;
